...
class Fairytale():    
    ...
    def Farmer(self):
        ...
        f = open('/home/pi/Pibo_Package_06/Pibo_Conversation/src/Fairytale/data/11_farmer_story.txt', 'r')
        lines = f.readlines()
        # print(lines)
        ...
        pibo = cm.tts(bhv="do_question_S", string=f"농부는 어떤 동물을 잡으려고 덫을 놓았을까?")
        ...
        pibo = cm.tts(bhv="do_question_L", string=f"독수리가 농부를 구해준 것을 알았을 때 농부의 기분은 고마웠을까?")
