...
class RunSchedule():
    ...
    def __init__(self):
        self.path = '/home/pi/Pibo_Package_06'
        self.completion = int
        self.act = ''
    ...
    def day(self):
        ...
        # out = subprocess.check_output([f'python3 /home/pi/Pibo_Package_06/Pibo_Conversation/src/greeting.py'], shell=True, stderr=subprocess.STDOUT, encoding="utf-8")  
